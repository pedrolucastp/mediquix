const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/QuickQuizGame-Yx6joqar.js","assets/GameContainer-Cx9z9Rey.js","assets/SelectorsComponent-kxMDd0Sf.js","assets/SelectorsComponent-DI9O7iNc.css","assets/GameContainer-D7CCTctq.css","assets/QuickQuizGame-Gi2DEHKx.css","assets/MemoryGame-DQIETdQO.js","assets/MemoryGame-DeVSjMv0.css","assets/WordSearchGame-BoNclx4o.js","assets/WordSearchGame-b5n9Qbb7.css","assets/HangmanGame-s9p1uBph.js","assets/HangmanGame-DkhSeYbw.css","assets/MyVocabulary-DuX9Cha3.js","assets/MyVocabulary-BSurKbvx.css","assets/CrosswordsGame-BxL3P6gm.js","assets/CrosswordsGame-C2ttsRhs.css","assets/AuthAction-CMXImPv6.js","assets/AuthAction-DQZXuj1Z.css"])))=>i.map(i=>d[i]);
/**
* @vue/shared v3.5.13
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pc="firebase-heartbeat-store";let mc=null;function gc(){return mc||(mc=ya("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)try{e.createObjectStore(pc)}catch(fx){}}}).catch((e=>{throw cc.create("idb-open",{originalErrorMessage:e.message})}))),mc}async function vc(e,t){try{const n=(await gc()).transaction(pc,"readwrite"),r=n.objectStore(pc);await r.put(t,yc(e)),await n.done}catch(fx){if(fx instanceof Fo)ka.warn(fx.message);else{const t=cc.create("idb-set",{originalErrorMessage:null==fx?void 0:fx.message});ka.warn(t.message)}}}function yc(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function il(e){if(e)try{const t=new Date(Number(e));if(!isNaN(t.getTime()))return t.toUTCString()}catch(fx){}}function sl(e){return 1e3*Number(e)}function ol(e){const[t,n,r]=e.split(".");if(void 0===t||void 0===n||void 0===r)return xc("JWT malformed, contained fewer than 3 sections"),null;try{const e=To(n);return e?JSON.parse(e):(xc("Failed to decode base64 JWT payload"),null)}catch(fx){return xc("Caught error parsing JWT payload as JSON",null==fx?void 0:fx.toString()),null}}function al(e){const t=ol(e);return Rc(t,"internal-error"),Rc(void 0!==t.exp,"internal-error"),Rc(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cl(e,t,n=!1){if(n)return t;try{return await t}catch(fx){throw fx instanceof Fo&&function({code:e}){return"auth/user-disabled"===e||"auth/user-token-expired"===e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(fx)&&e.auth.currentUser===e&&await e.auth.signOut(),fx}}class ll{constructor(e){this.user=e,this.isRunning=!1,this.timerId=null,this.errorBackoff=3e4}_start(){this.isRunning||(this.isRunning=!0,this.schedule())}_stop(){this.isRunning&&(this.isRunning=!1,null!==this.timerId&&clearTimeout(this.timerId))}getInterval(e){var t;if(e){const e=this.errorBackoff;return this.errorBackoff=Math.min(2*this.errorBackoff,96e4),e}{this.errorBackoff=3e4;const e=(null!==(t=this.user.stsTokenManager.expirationTime)&&void 0!==t?t:0)-Date.now()-3e5;return Math.max(0,e)}}schedule(e=!1){if(!this.isRunning)return;const t=this.getInterval(e);this.timerId=setTimeout((async()=>{await this.iteration()}),t)}async iteration(){try{await this.user.getIdToken(!0)}catch(fx){return void("auth/network-request-failed"===(null==fx?void 0:fx.code)&&this.schedule(!0))}this.schedule()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ll{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,t){const n=t=>new Promise(((n,r)=>{try{n(e(t))}catch(fx){r(fx)}}));n.onAbort=t,this.queue.push(n);const r=this.queue.length-1;return()=>{this.queue[r]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const t=[];try{for(const n of this.queue)await n(e),n.onAbort&&t.push(n.onAbort)}catch(fx){t.reverse();for(const r of t)try{r()}catch(n){}throw this.auth._errorFactory.create("login-blocked",{originalMessage:null==fx?void 0:fx.message})}}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zu{constructor(e,t,n,r,i=!1){this.auth=e,this.resolver=n,this.user=r,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(fx){this.reject(fx)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:r,tenantId:i,error:s,type:o}=e;if(s)return void this.reject(s);const a={auth:this.auth,requestUri:t,sessionId:n,tenantId:i||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(o)(a))}catch(fx){this.reject(fx)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Yu;case"linkViaPopup":case"linkViaRedirect":return Xu;case"reauthViaPopup":case"reauthViaRedirect":return Ju;default:Pc(this.auth,"internal-error")}}resolve(e){Fc(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Fc(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Qb(e){if(!e.startsWith(Kb)){const t=Wb.create("invalid-gtag-resource",{gtagURL:e});return Gb.warn(t.message),""}return e}function Yb(e){return Promise.all(e.map((e=>e.catch((e=>e)))))}function Jb(e,t){const n=function(e,t){let n;return window.trustedTypes&&(n=window.trustedTypes.createPolicy(e,t)),n}("firebase-js-sdk-policy",{createScriptURL:Qb}),r=document.createElement("script"),i=`${Kb}?l=${e}&id=${t}`;r.src=n?null==n?void 0:n.createScriptURL(i):i,r.async=!0,document.head.appendChild(r)}function Xb(e,t,n,r){return async function(i,...s){try{if("event"===i){const[r,i]=s;await async function(e,t,n,r,i){try{let s=[];if(i&&i.send_to){let e=i.send_to;Array.isArray(e)||(e=[e]);const r=await Yb(n);for(const n of e){const e=r.find((e=>e.measurementId===n)),i=e&&t[e.appId];if(!i){s=[];break}s.push(i)}}0===s.length&&(s=Object.values(t)),await Promise.all(s),e("event",r,i||{})}catch(fx){Gb.error(fx)}}(e,t,n,r,i)}else if("config"===i){const[i,o]=s;await async function(e,t,n,r,i,s){const o=r[i];try{if(o)await t[o];else{const e=(await Yb(n)).find((e=>e.measurementId===i));e&&await t[e.appId]}}catch(fx){Gb.error(fx)}e("config",i,s)}(e,t,n,r,i,o)}else if("consent"===i){const[t,n]=s;e("consent",t,n)}else if("get"===i){const[t,n,r]=s;e("get",t,n,r)}else if("set"===i){const[t]=s;e("set",t)}else e(i,...s)}catch(fx){Gb.error(fx)}}}const Zb=new class{constructor(e={},t=1e3){this.throttleMetadata=e,this.intervalMillis=t}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,t){this.throttleMetadata[e]=t}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}};function e_(e){return new Headers({Accept:"application/json","x-goog-api-key":e})}async function t_(e,t=Zb,n){const{appId:r,apiKey:i,measurementId:s}=e.options;if(!r)throw Wb.create("no-app-id");if(!i){if(s)return{measurementId:s,appId:r};throw Wb.create("no-api-key")}const o=t.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},a=new r_;return setTimeout((async()=>{a.abort()}),6e4),n_({appId:r,apiKey:i,measurementId:s},o,a,t)}async function n_(e,{throttleEndTimeMillis:t,backoffCount:n},r,i=Zb){var s;const{appId:o,measurementId:a}=e;try{await function(e,t){return new Promise(((n,r)=>{const i=Math.max(t-Date.now(),0),s=setTimeout(n,i);e.addEventListener((()=>{clearTimeout(s),r(Wb.create("fetch-throttle",{throttleEndTimeMillis:t}))}))}))}(r,t)}catch(fx){if(a)return Gb.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${null==fx?void 0:fx.message}]`),{appId:o,measurementId:a};throw fx}try{const t=await async function(e){var t;const{appId:n,apiKey:r}=e,i={method:"GET",headers:e_(r)},s="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig".replace("{app-id}",n),o=await fetch(s,i);if(200!==o.status&&304!==o.status){let e="";try{const n=await o.json();(null===(t=n.error)||void 0===t?void 0:t.message)&&(e=n.error.message)}catch(a){}throw Wb.create("config-fetch-failed",{httpStatus:o.status,responseMessage:e})}return o.json()}(e);return i.deleteThrottleMetadata(o),t}catch(fx){const c=fx;if(!function(e){if(!(e instanceof Fo&&e.customData))return!1;const t=Number(e.customData.httpStatus);return 429===t||500===t||503===t||504===t}(c)){if(i.deleteThrottleMetadata(o),a)return Gb.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${null==c?void 0:c.message}]`),{appId:o,measurementId:a};throw fx}const l=503===Number(null===(s=null==c?void 0:c.customData)||void 0===s?void 0:s.httpStatus)?Go(n,i.intervalMillis,30):Go(n,i.intervalMillis),u={throttleEndTimeMillis:Date.now()+l,backoffCount:n+1};return i.setThrottleMetadata(o,u),Gb.debug(`Calling attemptFetch again in ${l} millis`),n_(e,u,r,i)}}class r_{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach((e=>e()))}}async function i_(e,t,n,r,i,s,o){var a;const c=t_(e);c.then((t=>{n[t.measurementId]=t.appId,e.options.measurementId&&t.measurementId!==e.options.measurementId&&Gb.warn(`The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${t.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)})).catch((e=>Gb.error(e))),t.push(c);const l=
/**
 * @license
 * Copyright 2020 Google LLC
 *
