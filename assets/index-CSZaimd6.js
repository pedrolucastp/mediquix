const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/QuickQuizGame-DZ9L-WFv.js","assets/SelectorsComponent-EX9bJPd6.js","assets/SelectorsComponent-DI9O7iNc.css","assets/GamePerksMenu-C6MNeGd8.js","assets/GamePerksMenu-amueXGty.css","assets/QuickQuizGame-Clt4rbtj.css","assets/MemoryGame-x1gRXJHl.js","assets/MemoryGame-Cd8SUFxT.css","assets/WordSearchGame-N2cqEW01.js","assets/WordSearchGame-DQy8O4sS.css","assets/HangmanGame-L5KrT5ia.js","assets/HangmanGame-DO2ca-HY.css","assets/MyVocabulary-CBs9hk99.js","assets/MyVocabulary-BSurKbvx.css","assets/CrosswordsGame-C5DGkYDe.js","assets/CrosswordsGame-3sSgyX9C.css"])))=>i.map(i=>d[i]);
/**
* @vue/shared v3.5.13
 ...
 * limitations under the License.
 */
const Cb="firebase-installations-store";let Ab=null;function xb(){return Ab||(Ab=ya("firebase-installations-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(Cb)}})),Ab}async function Nb(e,t){const n=Eb(e),r=(await xb()).transaction(Cb,"readwrite"),i=r.objectStore(Cb),s=await i.get(n);return await i.put(t,n),await r.done,s&&s.fid===t.fid||Ib(e,t.fid),t}async function Pb(e){const t=Eb(e),n=(await xb()).transaction(Cb,"readwrite");await n.objectStore(Cb).delete(t),await n.done}async function Ob(e,t){const n=Eb(e),r=(await xb()).transaction(Cb,"readwrite"),i=r.objectStore(Cb),s=await i.get(n),o=t(s);return void 0===o?await i.delete(n):await i.put(o,n),await r.done,!o||s&&s.fid===o.fid||Ib(e,o.fid),o}
/**
 * @license
 * Copyright 2019 Google LLC
 *
