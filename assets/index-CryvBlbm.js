 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hr(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function v2(t,e=!1){const n=ut(t),i=await n.getIdToken(e),s=Ld(i);ge(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:Hr(xc(s.auth_time)),issuedAtTime:Hr(xc(s.iat)),expirationTime:Hr(xc(s.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function xc(t){return Number(t)*1e3}function Ld(t){const[e,n,i]=t.split(".");if(e===void 0||n===void 0||i===void 0)return Aa("JWT malformed, contained fewer than 3 sections"),null;try{const s=Wy(n);return s?JSON.parse(s):(Aa("Failed to decode base64 JWT payload"),null)}catch(s){return Aa("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function Sp(t){const e=Ld(t);return ge(e,"internal-error"),ge(typeof e.exp<"u","internal-error"),ge(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class js{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){ge(e.idToken,"internal-error"),ge(typeof e.idToken<"u","internal-error"),ge(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):Sp(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}updateFromIdToken(e){ge(e.length!==0,"internal-error");const n=Sp(e);this.updateTokensAndExpiration(e,null,n)}async getToken(e,n=!1){return!n&&this.accessToken&&!this.isExpired?this.accessToken:(ge(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:i,refreshToken:s,expiresIn:r}=await C2(e,n);this.updateTokensAndExpiration(i,s,Number(r))}updateTokensAndExpiration(e,n,i){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+i*1e3}static fromJSON(e,n){const{refreshToken:i,accessToken:s,expirationTime:r}=n,o=new js;return i&&(ge(typeof i=="string","internal-error",{appName:e}),o.refreshToken=i),s&&(ge(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),r&&(ge(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new js,this.toJSON())}_performRefresh(){return Gn("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tb(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function nb(t){const e=Dr(Lr(t)).link,n=e?Dr(Lr(e)).deep_link_id:null,i=Dr(Lr(t)).deep_link_id;return(i?Dr(Lr(i)).link:null)||i||n||e||t}class xd{constructor(e){var n,i,s,r,o,l;const c=Dr(Lr(e)),u=(n=c.apiKey)!==null&&n!==void 0?n:null,f=(i=c.oobCode)!==null&&i!==void 0?i:null,p=tb((s=c.mode)!==null&&s!==void 0?s:null);ge(u&&f&&p,"argument-error"),this.apiKey=u,this.operation=p,this.code=f,this.continueUrl=(r=c.continueUrl)!==null&&r!==void 0?r:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(l=c.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const n=nb(e);try{return new xd(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rb(t,e,n=!1){const{auth:i}=t;if(gn(i.app))return Promise.reject(Kn(i));const s="reauthenticate";try{const r=await po(t,S_(i,s,e,t),n);ge(r.idToken,i,"internal-error");const o=Ld(r.idToken);ge(o,i,"internal-error");const{sub:l}=o;return ge(t.uid===l,i,"user-mismatch"),hs._forOperation(t,s,r)}catch(r){throw(r==null?void 0:r.code)==="auth/user-not-found"&&ln(i,"user-mismatch"),r}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cb(t,e){return e?Hn(e):(ge(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dS="__/auth/handler",fS="emulator/auth/handler",hS=encodeURIComponent("fac");async function Up(t,e,n,i,s,r){ge(t.config.authDomain,t,"auth-domain-config-required"),ge(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:i,v:lr,eventId:s};if(e instanceof b_){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",Qv(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,p]of Object.entries({}))o[f]=p}if(e instanceof ko){const f=e.getScopes().filter(p=>p!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const c=await t._getAppCheckToken(),u=c?`#${hS}=${encodeURIComponent(c)}`:"";return`${pS(t)}?${Do(l).slice(1)}${u}`}function pS({config:t}){return t.emulator?Dd(t,fS):`https://${t.authDomain}/${dS}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Ci,q_;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,y){function g(){}g.prototype=y.prototype,T.D=y.prototype,T.prototype=new g,T.prototype.constructor=T,T.C=function(A,b,w){for(var E=Array(arguments.length-2),be=2;be<arguments.length;be++)E[be-2]=arguments[be];return y.prototype[b].apply(A,E)}}function n(){this.blockSize=-1}function i(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(i,n),i.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(T,y,g){g||(g=0);var A=Array(16);if(typeof y=="string")for(var b=0;16>b;++b)A[b]=y.charCodeAt(g++)|y.charCodeAt(g++)<<8|y.charCodeAt(g++)<<16|y.charCodeAt(g++)<<24;else for(b=0;16>b;++b)A[b]=y[g++]|y[g++]<<8|y[g++]<<16|y[g++]<<24;y=T.g[0],g=T.g[1],b=T.g[2];var w=T.g[3],E=y+(w^g&(b^w))+A[0]+3614090360&4294967295;y=g+(E<<7&4294967295|E>>>25),E=w+(b^y&(g^b))+A[1]+3905402710&4294967295,w=y+(E<<12&4294967295|E>>>20),E=b+(g^w&(y^g))+A[2]+606105819&4294967295,b=w+(E<<17&4294967295|E>>>15),E=g+(y^b&(w^y))+A[3]+3250441966&4294967295,g=b+(E<<22&4294967295|E>>>10),E=y+(w^g&(b^w))+A[4]+4118548399&4294967295,y=g+(E<<7&4294967295|E>>>25),E=w+(b^y&(g^b))+A[5]+1200080426&4294967295,w=y+(E<<12&4294967295|E>>>20),E=b+(g^w&(y^g))+A[6]+2821735955&4294967295,b=w+(E<<17&4294967295|E>>>15),E=g+(y^b&(w^y))+A[7]+4249261313&4294967295,g=b+(E<<22&4294967295|E>>>10),E=y+(w^g&(b^w))+A[8]+1770035416&4294967295,y=g+(E<<7&4294967295|E>>>25),E=w+(b^y&(g^b))+A[9]+2336552879&4294967295,w=y+(E<<12&4294967295|E>>>20),E=b+(g^w&(y^g))+A[10]+4294925233&4294967295,b=w+(E<<17&4294967295|E>>>15),E=g+(y^b&(w^y))+A[11]+2304563134&4294967295,g=b+(E<<22&4294967295|E>>>10),E=y+(w^g&(b^w))+A[12]+1804603682&4294967295,y=g+(E<<7&4294967295|E>>>25),E=w+(b^y&(g^b))+A[13]+4254626195&4294967295,w=y+(E<<12&4294967295|E>>>20),E=b+(g^w&(y^g))+A[14]+2792965006&4294967295,b=w+(E<<17&4294967295|E>>>15),E=g+(y^b&(w^y))+A[15]+1236535329&4294967295,g=b+(E<<22&4294967295|E>>>10),E=y+(b^w&(g^b))+A[1]+4129170786&4294967295,y=g+(E<<5&4294967295|E>>>27),E=w+(g^b&(y^g))+A[6]+3225465664&4294967295,w=y+(E<<9&4294967295|E>>>23),E=b+(y^g&(w^y))+A[11]+643717713&4294967295,b=w+(E<<14&4294967295|E>>>18),E=g+(w^y&(b^w))+A[0]+3921069994&4294967295,g=b+(E<<20&4294967295|E>>>12),E=y+(b^w&(g^b))+A[5]+3593408605&4294967295,y=g+(E<<5&4294967295|E>>>27),E=w+(g^b&(y^g))+A[10]+38016083&4294967295,w=y+(E<<9&4294967295|E>>>23),E=b+(y^g&(w^y))+A[15]+3634488961&4294967295,b=w+(E<<14&4294967295|E>>>18),E=g+(w^y&(b^w))+A[4]+3889429448&4294967295,g=b+(E<<20&4294967295|E>>>12),E=y+(b^w&(g^b))+A[9]+568446438&4294967295,y=g+(E<<5&4294967295|E>>>27),E=w+(g^b&(y^g))+A[14]+3275163606&4294967295,w=y+(E<<9&4294967295|E>>>23),E=b+(y^g&(w^y))+A[3]+4107603335&4294967295,b=w+(E<<14&4294967295|E>>>18),E=g+(w^y&(b^w))+A[8]+1163531501&4294967295,g=b+(E<<20&4294967295|E>>>12),E=y+(b^w&(g^b))+A[13]+2850285829&4294967295,y=g+(E<<5&4294967295|E>>>27),E=w+(g^b&(y^g))+A[2]+4243563512&4294967295,w=y+(E<<9&4294967295|E>>>23),E=b+(y^g&(w^y))+A[7]+1735328473&4294967295,b=w+(E<<14&4294967295|E>>>18),E=g+(w^y&(b^w))+A[12]+2368359562&4294967295,g=b+(E<<20&4294967295|E>>>12),E=y+(g^b^w)+A[5]+4294588738&4294967295,y=g+(E<<4&4294967295|E>>>28),E=w+(y^g^b)+A[8]+2272392833&4294967295,w=y+(E<<11&4294967295|E>>>21),E=b+(w^y^g)+A[11]+1839030562&4294967295,b=w+(E<<16&4294967295|E>>>16),E=g+(b^w^y)+A[14]+4259657740&4294967295,g=b+(E<<23&4294967295|E>>>9),E=y+(g^b^w)+A[1]+2763975236&4294967295,y=g+(E<<4&4294967295|E>>>28),E=w+(y^g^b)+A[4]+1272893353&4294967295,w=y+(E<<11&4294967295|E>>>21),E=b+(w^y^g)+A[7]+4139469664&4294967295,b=w+(E<<16&4294967295|E>>>16),E=g+(b^w^y)+A[10]+3200236656&4294967295,g=b+(E<<23&4294967295|E>>>9),E=y+(g^b^w)+A[13]+681279174&4294967295,y=g+(E<<4&4294967295|E>>>28),E=w+(y^g^b)+A[0]+3936430074&4294967295,w=y+(E<<11&4294967295|E>>>21),E=b+(w^y^g)+A[3]+3572445317&4294967295,b=w+(E<<16&4294967295|E>>>16),E=g+(b^w^y)+A[6]+76029189&4294967295,g=b+(E<<23&4294967295|E>>>9),E=y+(g^b^w)+A[9]+3654602809&4294967295,y=g+(E<<4&4294967295|E>>>28),E=w+(y^g^b)+A[12]+3873151461&4294967295,w=y+(E<<11&4294967295|E>>>21),E=b+(w^y^g)+A[15]+530742520&4294967295,b=w+(E<<16&4294967295|E>>>16),E=g+(b^w^y)+A[2]+3299628645&4294967295,g=b+(E<<23&4294967295|E>>>9),E=y+(b^(g|~w))+A[0]+4096336452&4294967295,y=g+(E<<6&4294967295|E>>>26),E=w+(g^(y|~b))+A[7]+1126891415&4294967295,w=y+(E<<10&4294967295|E>>>22),E=b+(y^(w|~g))+A[14]+2878612391&4294967295,b=w+(E<<15&4294967295|E>>>17),E=g+(w^(b|~y))+A[5]+4237533241&4294967295,g=b+(E<<21&4294967295|E>>>11),E=y+(b^(g|~w))+A[12]+1700485571&4294967295,y=g+(E<<6&4294967295|E>>>26),E=w+(g^(y|~b))+A[3]+2399980690&4294967295,w=y+(E<<10&4294967295|E>>>22),E=b+(y^(w|~g))+A[10]+4293915773&4294967295,b=w+(E<<15&4294967295|E>>>17),E=g+(w^(b|~y))+A[1]+2240044497&4294967295,g=b+(E<<21&4294967295|E>>>11),E=y+(b^(g|~w))+A[8]+1873313359&4294967295,y=g+(E<<6&4294967295|E>>>26),E=w+(g^(y|~b))+A[15]+4264355552&4294967295,w=y+(E<<10&4294967295|E>>>22),E=b+(y^(w|~g))+A[6]+2734768916&4294967295,b=w+(E<<15&4294967295|E>>>17),E=g+(w^(b|~y))+A[13]+1309151649&4294967295,g=b+(E<<21&4294967295|E>>>11),E=y+(b^(g|~w))+A[4]+4149444226&4294967295,y=g+(E<<6&4294967295|E>>>26),E=w+(g^(y|~b))+A[11]+3174756917&4294967295,w=y+(E<<10&4294967295|E>>>22),E=b+(y^(w|~g))+A[2]+718787259&4294967295,b=w+(E<<15&4294967295|E>>>17),E=g+(w^(b|~y))+A[9]+3951481745&4294967295,T.g[0]=T.g[0]+y&4294967295,T.g[1]=T.g[1]+(b+(E<<21&4294967295|E>>>11))&4294967295,T.g[2]=T.g[2]+b&4294967295,T.g[3]=T.g[3]+w&4294967295}i.prototype.u=function(T,y){y===void 0&&(y=T.length);for(var g=y-this.blockSize,A=this.B,b=this.h,w=0;w<y;){if(b==0)for(;w<=g;)s(this,T,w),w+=this.blockSize;if(typeof T=="string"){for(;w<y;)if(A[b++]=T.charCodeAt(w++),b==this.blockSize){s(this,A),b=0;break}}else for(;w<y;)if(A[b++]=T[w++],b==this.blockSize){s(this,A),b=0;break}}this.h=b,this.o+=y},i.prototype.v=function(){var T=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);T[0]=128;for(var y=1;y<T.length-8;++y)T[y]=0;var g=8*this.o;for(y=T.length-8;y<T.length;++y)T[y]=g&255,g/=256;for(this.u(T),T=Array(16),y=g=0;4>y;++y)for(var A=0;32>A;A+=8)T[g++]=this.g[y]>>>A&255;return T};function r(T,y){var g=l;return Object.prototype.hasOwnProperty.call(g,T)?g[T]:g[T]=y(T)}function o(T,y){this.h=y;for(var g=[],A=!0,b=T.length-1;0<=b;b--){var w=T[b]|0;A&&w==y||(g[b]=w,A=!1)}this.g=g}var l={};function c(T){return-128<=T&&128>T?r(T,function(y){return new o([y|0],0>y?-1:0)}):new o([T|0],0>T?-1:0)}function u(T){if(isNaN(T)||!isFinite(T))return p;if(0>T)return D(u(-T));for(var y=[],g=1,A=0;T>=g;A++)y[A]=T/g|0,g*=4294967296;return new o(y,0)}function f(T,y){if(T.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(T.charAt(0)=="-")return D(f(T.substring(1),y));if(0<=T.indexOf("-"))throw Error('number format error: interior "-" character');for(var g=u(Math.pow(y,8)),A=p,b=0;b<T.length;b+=8){var w=Math.min(8,T.length-b),E=parseInt(T.substring(b,b+w),y);8>w?(w=u(Math.pow(y,w)),A=A.j(w).add(u(E))):(A=A.j(g),A=A.add(u(E)))}return A}var p=c(0),m=c(1),I=c(16777216);t=o.prototype,t.m=function(){if(L(this))return-D(this).m();for(var T=0,y=1,g=0;g<this.g.length;g++){var A=this.i(g);T+=(0<=A?A:4294967296+A)*y,y*=4294967296}return T},t.toString=function(T){if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(R(this))return"0";if(L(this))return"-"+D(this).toString(T);for(var y=u(Math.pow(T,6)),g=this,A="";;){var b=F(g,y).g;g=C(g,b.j(y));var w=((0<g.g.length?g.g[0]:g.h)>>>0).toString(T);if(g=b,R(g))return w+A;for(;6>w.length;)w="0"+w;A=w+A}},t.i=function(T){return 0>T?0:T<this.g.length?this.g[T]:this.h};function R(T){if(T.h!=0)return!1;for(var y=0;y<T.g.length;y++)if(T.g[y]!=0)return!1;return!0}function L(T){return T.h==-1}t.l=function(T){return T=C(this,T),L(T)?-1:R(T)?0:1};function D(T){for(var y=T.g.length,g=[],A=0;A<y;A++)g[A]=~T.g[A];return new o(g,~T.h).add(m)}t.abs=function(){return L(this)?D(this):this},t.add=function(T){for(var y=Math.max(this.g.length,T.g.length),g=[],A=0,b=0;b<=y;b++){var w=A+(this.i(b)&65535)+(T.i(b)&65535),E=(w>>>16)+(this.i(b)>>>16)+(T.i(b)>>>16);A=E>>>16,w&=65535,E&=65535,g[b]=E<<16|w}return new o(g,g[g.length-1]&-2147483648?-1:0)};function C(T,y){return T.add(D(y))}t.j=function(T){if(R(this)||R(T))return p;if(L(this))return L(T)?D(this).j(D(T)):D(D(this).j(T));if(L(T))return D(this.j(D(T)));if(0>this.l(I)&&0>T.l(I))return u(this.m()*T.m());for(var y=this.g.length+T.g.length,g=[],A=0;A<2*y;A++)g[A]=0;for(A=0;A<this.g.length;A++)for(var b=0;b<T.g.length;b++){var w=this.i(A)>>>16,E=this.i(A)&65535,be=T.i(b)>>>16,Fe=T.i(b)&65535;g[2*A+2*b]+=E*Fe,O(g,2*A+2*b),g[2*A+2*b+1]+=w*Fe,O(g,2*A+2*b+1),g[2*A+2*b+1]+=E*be,O(g,2*A+2*b+1),g[2*A+2*b+2]+=w*be,O(g,2*A+2*b+2)}for(A=0;A<y;A++)g[A]=g[2*A+1]<<16|g[2*A];for(A=y;A<2*y;A++)g[A]=0;return new o(g,0)};function O(T,y){for(;(T[y]&65535)!=T[y];)T[y+1]+=T[y]>>>16,T[y]&=65535,y++}function x(T,y){this.g=T,this.h=y}function F(T,y){if(R(y))throw Error("division by zero");if(R(T))return new x(p,p);if(L(T))return y=F(D(T),y),new x(D(y.g),D(y.h));if(L(y))return y=F(T,D(y)),new x(D(y.g),y.h);if(30<T.g.length){if(L(T)||L(y))throw Error("slowDivide_ only works with positive integers.");for(var g=m,A=y;0>=A.l(T);)g=j(g),A=j(A);var b=V(g,1),w=V(A,1);for(A=V(A,2),g=V(g,2);!R(A);){var E=w.add(A);0>=E.l(T)&&(b=b.add(g),w=E),A=V(A,1),g=V(g,1)}return y=C(T,b.j(y)),new x(b,y)}for(b=p;0<=T.l(y);){for(g=Math.max(1,Math.floor(T.m()/y.m())),A=Math.ceil(Math.log(g)/Math.LN2),A=48>=A?1:Math.pow(2,A-48),w=u(g),E=w.j(y);L(E)||0<E.l(T);)g-=A,w=u(g),E=w.j(y);R(w)&&(w=m),b=b.add(w),T=C(T,E)}return new x(b,T)}t.A=function(T){return F(this,T).h},t.and=function(T){for(var y=Math.max(this.g.length,T.g.length),g=[],A=0;A<y;A++)g[A]=this.i(A)&T.i(A);return new o(g,this.h&T.h)},t.or=function(T){for(var y=Math.max(this.g.length,T.g.length),g=[],A=0;A<y;A++)g[A]=this.i(A)|T.i(A);return new o(g,this.h|T.h)},t.xor=function(T){for(var y=Math.max(this.g.length,T.g.length),g=[],A=0;A<y;A++)g[A]=this.i(A)^T.i(A);return new o(g,this.h^T.h)};function j(T){for(var y=T.g.length+1,g=[],A=0;A<y;A++)g[A]=T.i(A)<<1|T.i(A-1)>>>31;return new o(g,T.h)}function V(T,y){var g=y>>5;y%=32;for(var A=T.g.length-g,b=[],w=0;w<A;w++)b[w]=0<y?T.i(w+g)>>>y|T.i(w+g+1)<<32-y:T.i(w+g);return new o(b,T.h)}i.prototype.digest=i.prototype.v,i.prototype.reset=i.prototype.s,i.prototype.update=i.prototype.u,q_=i,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=u,o.fromString=f,Ci=o}).apply(typeof Gp<"u"?Gp:typeof self<"u"?self:typeof window<"u"?window:{});var ua=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
